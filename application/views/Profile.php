  	...
  	<div class="container profile-container">
		...
		<div class="row">
			<div class="user_information table-responsive">
				...
				<?php if(isset($user_profile['link'])) { ?><div class="basic_information"><a href="<?= $user_profile['link'] ?>" target="_blank" class="btn btn-lg btn-default btn-block" role="button">View Profile</a></div>
				<?php } ?>
		    </div>
	    </div>
